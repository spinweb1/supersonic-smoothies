    ...
    <div class="add-smoothie container">
        ...
        <form @submit.prevent="AddSmoothie">
            ...
            <div class="add-ingredient title">
                 ...
                 <input type="text" name="add-ingredient" placeholder="amount" class="ingredient input" style="margin-left: 40px;" @keydown.enter.prevent="AddIngredient(); setFocus();" v-model="another.amount">
            </div>
            <div class="field center-align flex">
                 <button class="btn green lighten-1" @click="setFocus()">Add Smoothie</button>
                 <router-link :to="{ name: 'Index' }">
                    <button class="btn red lighten-1">Cancel</button>
                 </router-link>
            </div>
        </form>
    </div>
